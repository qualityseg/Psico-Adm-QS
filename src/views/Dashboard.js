...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://sparkling-capris-bass.cyclic.app/api/evaluations/count?instituicaoNome=${instituicaoNome}`)
      .then(response => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://sparkling-capris-bass.cyclic.app/api/UserCountByInstitution?instituicaoNome=${institutionName}`)
      .then(response => {
